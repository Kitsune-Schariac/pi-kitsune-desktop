    ...
    <aside className="sidebar-shell flex w-[18%] flex-col bg-[color-mix(in_oklch,var(--surface-sunken)_calc(var(--sidebar-alpha)_*_100%),transparent)]">
      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <button
          ...
          className="rounded-md p-2 text-neutral-400 transition duration-fast ease-out hover:bg-neutral-200/70 hover:text-neutral-700"
          title="设置"
        >
      ...
      <div className="space-y-1 px-3 py-3">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm text-neutral-600 transition duration-fast ease-out hover:bg-neutral-200/60 hover:text-neutral-900"
        >
      ...
      <div className="flex min-h-0 flex-1 flex-col">
        <div className="flex items-center justify-between px-4 pb-1 pt-3">
          ...
          <button
            ...
            disabled={adding}
            className="rounded-sm p-1 text-neutral-400 transition duration-fast ease-out hover:bg-neutral-200/70 hover:text-neutral-700 disabled:opacity-40"
